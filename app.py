...
with st.sidebar:
    selected = option_menu(
                ...
                options=["Home", "About", "Login"],  # required
                icons=["house", "person-square", "login"],  # optional
...
# The github repo code.
    ...
    if selected == "Login":  
        st_lottie(lottie_Login,height=150,width=270,key="coding5")
        st.subheader("Consider Logging in or Singing Up")
        st.markdown(
            """
            <div style='
            background-color:#a873b0; 
            ...
            align-items:center;
            justify-content:center;'>
                    <a  href="file://C:/Users/91954/Desktop/movie-recommendation-app/frontend/movie-recommendation-frontend/public/login.html" 
                           style='color: black; 
                           text-decoration:none;
                           padding-top:6px;
                           padding-bottom:5px;
